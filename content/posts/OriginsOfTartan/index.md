...
weave constant is what lets a [pattern]({{< ref "Tartan" >}}) be a clean unit of meaning.
...
[Falkirk]({{< ref "Tartan" >}}) cloth is a **herringbone**; the Hallstatt corpus runs to
...
- **West / Atlantic:** the British and **Irish** woollen tradition, the [Falkirk]({{< ref "Tartan" >}})
...
- **3rd century AD — the [Falkirk]({{< ref "Tartan" >}}) sett.** Scotland's oldest surviving
...
- **16th century — the [Glen Affric tartan]({{< ref "TarimTartan" >}}).** Pulled from a peat bog
...
book. The Dictionary's whole approach — treating a tartan as a [pattern]({{< ref "Tartan" >}})
...
[definition]({{< ref "Tartan" >}}) requires survives first only at early-modern Glen Affric — so
...
*Companion piece: [**The Tarim Tartan**]({{< ref "TarimTartan" >}}) takes the oldest surviving
specimen and works a sett from it. See also [**What is Tartan?**]({{< ref "Tartan" >}}).*
