...
|---|---|---|---|
| B | <code style="background-color:#2C607C;"><span style="color:#2C607C;filter:grayscale(1) invert(1) contrast(100);">#2C607C</span></code> `#2C607C` | B <code style="background-color:#2C4084;"><span style="color:#2C4084;filter:grayscale(1) invert(1) contrast(100);">#2C4084</span></code> | 0.10 |
