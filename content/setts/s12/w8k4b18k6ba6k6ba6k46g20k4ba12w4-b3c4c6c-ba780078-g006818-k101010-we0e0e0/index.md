...
|---|---|---|---|
| B | <code style="background-color:#3C4C6C;"><span style="color:#3C4C6C;filter:grayscale(1) invert(1) contrast(100);">#3C4C6C</span></code> `#3C4C6C` | B <code style="background-color:#2C4084;"><span style="color:#2C4084;filter:grayscale(1) invert(1) contrast(100);">#2C4084</span></code> | 0.06 |
