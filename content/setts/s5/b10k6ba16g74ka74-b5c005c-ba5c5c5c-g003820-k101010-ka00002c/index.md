...
| P | <code style="background-color:#5C005C;"><span style="color:#5C005C;filter:grayscale(1) invert(1) contrast(100);">#5C005C</span></code> `#5C005C` | B <code style="background-color:#2C4084;"><span style="color:#2C4084;filter:grayscale(1) invert(1) contrast(100);">#2C4084</span></code> | 0.15 |

# Sample pattern

![Tartan detail](tartan.png "DB/74 DG74 N16 K6 P/10 tartan")

ID: /setts/s5/b10k6ba16g74ka74-b5c005c-ba5c5c5c-g003820-k101010-ka00002c/
