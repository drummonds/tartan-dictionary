...
|---|---|---|---|
| B | <code style="background-color:#5CACDC;"><span style="color:#5CACDC;filter:grayscale(1) invert(1) contrast(100);">#5CACDC</span></code> `#5CACDC` | W <code style="background-color:#F4F4F0;"><span style="color:#F4F4F0;filter:grayscale(1) invert(1) contrast(100);">#F4F4F0</span></code> | 0.28 |
