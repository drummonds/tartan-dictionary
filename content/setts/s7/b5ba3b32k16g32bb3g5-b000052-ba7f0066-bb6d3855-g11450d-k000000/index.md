...
| N | <code style="background-color:#6D3855;"><span style="color:#6D3855;filter:grayscale(1) invert(1) contrast(100);">#6D3855</span></code> `#6D3855` | B <code style="background-color:#2C4084;"><span style="color:#2C4084;filter:grayscale(1) invert(1) contrast(100);">#2C4084</span></code> | 0.13 |
| P | <code style="background-color:#7F0066;"><span style="color:#7F0066;filter:grayscale(1) invert(1) contrast(100);">#7F0066</span></code> `#7F0066` | B <code style="background-color:#2C4084;"><span style="color:#2C4084;filter:grayscale(1) invert(1) contrast(100);">#2C4084</span></code> | 0.18 |

# Sample pattern

![Tartan detail](tartan.png "DB/5 P3 DB32 K16 DG32 N3 DG/5 tartan")

## Nearest tartans

The nearest existing variants by ΔTartan distance.

1. [MacThomas LC](/setts/s7/b10ba6b64k32g64bb6g10-b000052-ba7f0066-bb6d3855-g11450d-k000000/) — ΔT 0.00
