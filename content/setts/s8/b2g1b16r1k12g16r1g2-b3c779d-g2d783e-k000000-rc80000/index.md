...
|---|---|---|---|
| B | <code style="background-color:#3C779D;"><span style="color:#3C779D;filter:grayscale(1) invert(1) contrast(100);">#3C779D</span></code> `#3C779D` | B <code style="background-color:#2C4084;"><span style="color:#2C4084;filter:grayscale(1) invert(1) contrast(100);">#2C4084</span></code> | 0.16 |
| G | <code style="background-color:#2D783E;"><span style="color:#2D783E;filter:grayscale(1) invert(1) contrast(100);">#2D783E</span></code> `#2D783E` | G <code style="background-color:#006400;"><span style="color:#006400;filter:grayscale(1) invert(1) contrast(100);">#006400</span></code> | 0.08 |
