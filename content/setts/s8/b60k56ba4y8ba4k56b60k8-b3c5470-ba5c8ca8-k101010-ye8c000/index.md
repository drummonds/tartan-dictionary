...
|---|---|---|---|
| B | <code style="background-color:#3C5470;"><span style="color:#3C5470;filter:grayscale(1) invert(1) contrast(100);">#3C5470</span></code> `#3C5470` | B <code style="background-color:#2C4084;"><span style="color:#2C4084;filter:grayscale(1) invert(1) contrast(100);">#2C4084</span></code> | 0.08 |
