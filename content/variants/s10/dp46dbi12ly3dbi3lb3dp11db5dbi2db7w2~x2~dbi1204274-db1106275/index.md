...
provenance below. It is one weaving of the [sett](/tartans/d/di/diamond-jubilee/) (the scale-free proportion — the
same cloth at any scale or shade), whose colour order is pattern [BBYBWBBBBW](/stripes/bbybwbbbbw/).

Part of the [Diamond Jubilee](/tartans/d/di/diamond-jubilee/) tartan — the named design grouping this sett with its other cloths.

Sourced from tartans-authority.  It is a [10 stripe tartan](/stripes/stripes10/).

Original link <code>http://www.tartansauthority.com/tartan-ferret/display/10551/</code> — retired · [Internet Archive copy](https://web.archive.org/web/*/http://www.tartansauthority.com/tartan-ferret/display/10551/*)
...
<dt>data date</dt><dd>19th Jan. 2012 <small>(this record)</small></dd>
...
## Thread count
DP/92 DBi24 LY6 DBi6 LB6 DP22 DB10 DBi4 DB14 W/4
...
<img class="tartan-sample" src="tartan.png?w=880&tpcm=16" alt="DP/92 DBi24 LY6 DBi6 LB6 DP22 DB10 DBi4 DB14 W/4 tartan" width="880" height="480">

ID: /variants/s10/dp46dbi12ly3dbi3lb3dp11db5dbi2db7w2~x2~dbi1204274-db1106275/
