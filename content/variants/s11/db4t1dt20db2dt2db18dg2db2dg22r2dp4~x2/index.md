...
date: 2023-03-18
---
This page is one **sett** — a single exact thread-count. It belongs to the [tartan](/setts/db4t1dt20db2dt2db18dg2db2dg22r2dp4/)
...
<div class="nn-table"><div class="nn-h nn-dt">ΔTartan</div><div class="nn-h nn-threads">Threads</div><div class="nn-h nn-name">Variant</div><div class="nn-h nn-sw">Sett</div><div class="nn-dt nn-base">—</div><div class="nn-threads nn-base">590</div><div class="nn-name nn-base"><a href="/variants/s11/db4t1dt20db2dt2db18dg2db2dg22r2dp4~x2/">Heartlands</a></div><div class="nn-sw nn-base"><img class="nn-swatch" src="/variants/s11/db4t1dt20db2dt2db18dg2db2dg22r2dp4~x2/sett.png" alt="sett" loading="lazy" style="width:608px"></div><div class="nn-dt"><a href="/ttd/edit/#slug=db4t1dt20db2dt2db18dg2db2dg22k2dp4~x2&amp;base=db4t1dt20db2dt2db18dg2db2dg22r2dp4~x2" title="compare in the TTD">0.60</a></div><div class="nn-threads">300</div><div class="nn-name"><a href="/variants/s11/db4t1dt20db2dt2db18dg2db2dg22k2dp4~x2/">Heartlands Fancy Tartan</a></div><div class="nn-sw"><span class="nn-swatch" role="img" aria-label="sett" style="display:inline-block;width:608px;height:26px;background-image:url(/variants/s11/db4t1dt20db2dt2db18dg2db2dg22k2dp4~x2/sett.png);background-size:608px 26px;background-repeat:repeat-x;background-position-x:-229px;transform:scaleX(-1)"></span></div></div>

## Neighbour map

Every grey dot is one of 13620 variants placed by the first two principal components of the ΔTartan feature space (42% of its variance). Red is this tartan; blue dots are its nearest — click one to open its page.

<svg viewBox="0 0 640 380" role="img" style="max-width:100%;height:auto;border:1px solid #e0e0e0;border-radius:4px;display:block" xmlns="http://www.w3.org/2000/svg"><image href="/nn/cloud.v1.png" width="640" height="380"/><a href="/variants/s11/db4t1dt20db2dt2db18dg2db2dg22k2dp4~x2/"><circle cx="346.4" cy="157.8" r="4" fill="#3465a4"><title>Heartlands Fancy Tartan</title></circle></a><circle cx="354.4" cy="166.4" r="5" fill="#c00000"/><text x="320" y="376" text-anchor="middle" font-size="11" fill="#999">ground</text><text x="11" y="190" text-anchor="middle" font-size="11" fill="#999" transform="rotate(-90 11 190)">complexity</text></svg>

ID: /variants/s11/db4t1dt20db2dt2db18dg2db2dg22r2dp4~x2/
