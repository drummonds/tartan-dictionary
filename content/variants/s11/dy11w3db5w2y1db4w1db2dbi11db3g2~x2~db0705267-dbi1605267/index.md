...
date: 2023-03-18
---
This page is one **sett** — a single exact thread-count. It belongs to the [tartan](/setts/dy11w3db5w2y1db4w1db2dbi11db3g2/)
(the same proportion at any scale), whose colour order is pattern [GBBBWBGWBWG](/stripes/gbbbwbgwbwg/).
...
<svg viewBox="0 0 640 380" role="img" style="max-width:100%;height:auto;border:1px solid #e0e0e0;border-radius:4px;display:block" xmlns="http://www.w3.org/2000/svg"><image href="/nn/cloud.v1.png" width="640" height="380"/><a href="/variants/s10/ly7g11db4lb31db4g11dy4db14w3db4~x2/"><circle cx="140.9" cy="179.6" r="4" fill="#3465a4"><title>State Seal of Nebraska (Fashion)</title></circle></a><circle cx="127.7" cy="172.4" r="5" fill="#c00000"/><text x="320" y="376" text-anchor="middle" font-size="11" fill="#999">ground</text><text x="11" y="190" text-anchor="middle" font-size="11" fill="#999" transform="rotate(-90 11 190)">complexity</text></svg>
