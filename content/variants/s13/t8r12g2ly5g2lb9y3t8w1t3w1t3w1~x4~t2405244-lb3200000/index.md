...
date: 2023-03-18
---
This page is one **sett** — a single exact thread-count. It belongs to the [tartan](/setts/t8r12g2ly5g2lb9y3t8w1t3w1t3w1/)
(the same proportion at any scale), whose colour order is pattern [BRGYGWGBWBWBW](/stripes/brgygwgbwbwbw/).
...
<svg viewBox="0 0 640 380" role="img" style="max-width:100%;height:auto;border:1px solid #e0e0e0;border-radius:4px;display:block" xmlns="http://www.w3.org/2000/svg"><image href="/nn/cloud.v1.png" width="640" height="380"/><a href="/variants/s14/lb14r12g2ly5g2n9dy2lb8w1lb3w1lb3w1lb8~x2/"><circle cx="222.4" cy="137.6" r="4" fill="#3465a4"><title>Saint Joseph de Sorel (District)</title></circle></a><circle cx="148.9" cy="155.8" r="5" fill="#c00000"/><text x="320" y="376" text-anchor="middle" font-size="11" fill="#999">ground</text><text x="11" y="190" text-anchor="middle" font-size="11" fill="#999" transform="rotate(-90 11 190)">complexity</text></svg>
