...
date: 2023-03-18
---
This page is one **sett** — a single exact thread-count. It belongs to the [tartan](/setts/w4r1w4y1k1r6w1r4w1r6k1y1w4g1/)
(the same proportion at any scale), whose colour order is pattern [GWGKRWRWRKGWRW](/stripes/gwgkrwrwrkgwrw/).
...
<svg viewBox="0 0 640 380" role="img" style="max-width:100%;height:auto;border:1px solid #e0e0e0;border-radius:4px;display:block" xmlns="http://www.w3.org/2000/svg"><image href="/nn/cloud.v1.png" width="640" height="380"/><a href="/variants/s14/w10r3w10y5k2r6w2r6w2r6db2y2w5g2/"><circle cx="110.2" cy="173.7" r="4" fill="#3465a4"><title>Ogilvy</title></circle></a><circle cx="161.8" cy="163.2" r="5" fill="#c00000"/><text x="320" y="376" text-anchor="middle" font-size="11" fill="#999">ground</text><text x="11" y="190" text-anchor="middle" font-size="11" fill="#999" transform="rotate(-90 11 190)">complexity</text></svg>
